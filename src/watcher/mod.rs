...
mod tests {
    ...
    fn watcher_handles_file_deletion() {
        ...
        // On macOS, notify may report delete as Modify or Delete depending on timing
        assert!(
    ...
    fn watcher_debounces_rapid_writes() {
        ...
        // Rapid writes to the same file should coalesce
        ...
        // Debouncing should reduce 5 rapid writes to 1-2 events
    ...
    fn baseline_snapshot_skips_when_index_exists() {
        ...
        // Add a new file and create a second watcher — should NOT re-snapshot
